                    ...
                    <div class="row gy-5 justify-content-center">
                        ...
                        <div class="col-12 col-lg-5 d-flex align-items-center">
                            <div class="d-flex gap-3 flex-column w-100 ">
                                <a href="{{ url('/auth/google/redirect') }}" class="btn bsb-btn-2xl btn-outline-dark rounded-0 d-flex align-items-center">
                                ...
                                <a href="{{ url('/auth/redirect') }}" class="btn bsb-btn-2xl btn-outline-dark rounded-0 d-flex align-items-center">
